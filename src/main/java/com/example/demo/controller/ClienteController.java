...
public class ClienteController {
    ...
    @Operation(description = "Obtém detalhes de um cliente por CPF")
    public ResponseEntity<?> detalharCliente(@PathVariable String cpf){
        Resultado resultado = clienteService.detalharCliente(cpf);
